...
then
    ...
    #Optimized with -sUV -T4 -F --version-intensity 0
    sudo nmap  -iL $file -oA $file.resumenmap-udp --top-ports $topports -Pn -T4 -sUV -T4 -F --version-intensity 0 --open -vv --min-rate 5500 --max-rate 5700 --min-rtt-timeout 100ms --max-hostgroup 16 -n;
