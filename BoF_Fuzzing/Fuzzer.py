...
def eip_offset():
    ...
    # In x64dbg command: ERC --pattern o 1jB0  to get the exact offset where 1jB0 is the ascii value in the stack we want to check
...
def bad_chars():
    #In ERC ERC --bytearray to create the byte array file and once the program crash run ERC --compare to identify bad characters
    #all_chars = bytes([
    #    0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
    #    0xF8, 0xF9, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE, 0xFF
    #])
    allchars = (b"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f"
